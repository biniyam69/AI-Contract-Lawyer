...
const App = () => (
  <div style={{display: 'flex', position: 'relative', alignItems: 'center', justifyContent: 'space-around', height: '100vh', gap: '10px'}}>

    <div style={{flex: '1', border: '2px solid green', borderRadius: '10px', padding: '60px' , maxWidth: '400px', marginLeft: '120px', marginTop: '60px'}}>
      <Auth
    ...
    {/* Text */}
    <div style={{ position: 'absolute', marginTop: '160px',top: '-1px', left: '330px', marginLeft: '50px', transform: 'translateX(-50%)', border: '2px ', font: 'menu', padding: '0px', textAlign: 'center', fontSize: '15px', color: 'green' }}>
